...
type PortRegistrationRequest struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	DataKeeperName string                 `protobuf:"bytes,1,opt,name=dataKeeperName,proto3" json:"dataKeeperName,omitempty"` // Name of the DataKeeper
	PortNumber     int32                  `protobuf:"varint,2,opt,name=portNumber,proto3" json:"portNumber,omitempty"`        // Port number being reported
	IsAvailable    bool                   `protobuf:"varint,3,opt,name=isAvailable,proto3" json:"isAvailable,omitempty"`      // Availability status of the port
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *PortRegistrationRequest) Reset() {
	*x = PortRegistrationRequest{}
	mi := &file_dfs_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PortRegistrationRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PortRegistrationRequest) ProtoMessage() {}

func (x *PortRegistrationRequest) ProtoReflect() protoreflect.Message {
	mi := &file_dfs_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PortRegistrationRequest.ProtoReflect.Descriptor instead.
func (*PortRegistrationRequest) Descriptor() ([]byte, []int) {
	return file_dfs_proto_rawDescGZIP(), []int{10}
}

func (x *PortRegistrationRequest) GetDataKeeperName() string {
	if x != nil {
		return x.DataKeeperName
	}
	return ""
...
func (x *PortRegistrationRequest) GetPortNumber() int32 {
	if x != nil {
		return x.PortNumber
	}
	return 0
...
func (x *PortRegistrationRequest) GetIsAvailable() bool {
	if x != nil {
		return x.IsAvailable
	}
	return false
...
type PortRegistrationResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Success       bool                   `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"` // Indicates if the MasterTracker successfully recorded the status
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PortRegistrationResponse) Reset() {
	*x = PortRegistrationResponse{}
	mi := &file_dfs_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PortRegistrationResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PortRegistrationResponse) ProtoMessage() {}

func (x *PortRegistrationResponse) ProtoReflect() protoreflect.Message {
	mi := &file_dfs_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PortRegistrationResponse.ProtoReflect.Descriptor instead.
func (*PortRegistrationResponse) Descriptor() ([]byte, []int) {
	return file_dfs_proto_rawDescGZIP(), []int{11}
}

func (x *PortRegistrationResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
var file_dfs_proto_rawDesc = string([]byte{
	...
	0x65, 0x22, 0x83, 0x01, 0x0a, 0x17, 0x50, 0x6f, 0x72, 0x74, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74,
	...
	,
	...
	,
...
var file_dfs_proto_goTypes = []any{
	...
	(*PortRegistrationRequest)(nil),  // 10: dfs.PortRegistrationRequest
	(*PortRegistrationResponse)(nil), // 11: dfs.PortRegistrationResponse
...
var file_dfs_proto_depIdxs = []int32{
	...
	10, // 6: dfs.MasterTracker.RegisterPortStatus:input_type -> dfs.PortRegistrationRequest
	0,  // 7: dfs.DataKeeper.ReplicateFile:input_type -> dfs.ReplicationRequest
	3,  // 8: dfs.Client.NotifyUploadCompletion:input_type -> dfs.UploadSuccessResponse
	4,  // 9: dfs.MasterTracker.RequestUpload:output_type -> dfs.UploadResponse
	12, // 10: dfs.MasterTracker.RequestUploadSuccess:output_type -> google.protobuf.Empty
	6,  // 11: dfs.MasterTracker.RequestDownload:output_type -> dfs.DownloadResponse
	8,  // 12: dfs.MasterTracker.SendHeartbeat:output_type -> dfs.HeartbeatResponse
	11, // 13: dfs.MasterTracker.RegisterPortStatus:output_type -> dfs.PortRegistrationResponse
	2,  // 14: dfs.DataKeeper.ReplicateFile:output_type -> dfs.FileUploadSuccess
	12, // 15: dfs.Client.NotifyUploadCompletion:output_type -> google.protobuf.Empty
